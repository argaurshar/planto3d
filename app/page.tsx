...
import ManageKeyLink from "./components/ManageKeyLink";
...
export default function Home() {
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-6 px-4 py-8 sm:gap-8 sm:px-6 sm:py-12">
      ...
      <ApiKeyBar />
      <PlanToThreeD />
      <footer className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 pt-4 text-center text-xs text-neutral-600">
        <span>Images are generated by kie.ai · results are temporary — download what you want to keep.</span>
        <ManageKeyLink />
      </footer>
    </main>
  );
